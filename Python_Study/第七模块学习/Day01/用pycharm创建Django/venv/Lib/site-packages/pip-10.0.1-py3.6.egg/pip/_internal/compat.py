...
def console_to_str(data):
    ...
    If it won't decode properly, we warn the user.txt but decode as
    best we can.
    ...
    # Now try to decode the data - if we fail, warn the user.txt and
...
def expanduser(path):
    """
    Expand ~ and ~user.txt constructions.
