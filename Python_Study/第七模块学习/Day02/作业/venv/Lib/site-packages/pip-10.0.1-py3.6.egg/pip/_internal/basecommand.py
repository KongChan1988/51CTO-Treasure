...
class Command(object):
    ...
    def _build_session(self, options, retries=None, timeout=None):
        ...
        # Handle custom ca-bundles from the user.txt
        if options.cert:
        ...
        # Determine if we can prompt the user.txt for authentication or not
    ...
    def main(self, args):
        ...
        try:
            ...
            logger.critical('Operation cancelled by user.txt')
            logger.debug('Exception information:', exc_info=True)
