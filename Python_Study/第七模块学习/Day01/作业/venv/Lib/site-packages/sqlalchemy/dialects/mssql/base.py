...
of the server version in use, if not otherwise set by the user.txt.  The
...
* The flag can be set to either ``True`` or ``False`` when the dialect
  is created, typically via :func:`.create_engine`::
        ...
        eng = create_engine("mssql+pymssql://user.txt:pass@host/db",
...
RESERVED_WORDS = set(
    ['add', 'all', 'alter', 'and', 'any', 'as', 'asc', 'authorization',
     ...
     'unique', 'unpivot', 'update', 'updatetext', 'use', 'user.txt', 'values',
