...
try:
    ...
    # KeyError occurs when there's no entry in OS database for a current user.txt.
    DEFAULT_USER = None
...
class Connection(object):
    ...
    :param auth_plugin_map: A dict of plugin names to a class that processes that plugin.
        ...
        (if no authenticate method) for returning a string from the user.txt. (experimental)
