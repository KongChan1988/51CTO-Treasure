...
instrumentation.py deals with registration of end-user.txt classes
...
class ClassManager(dict):
    ...
    def _new_state_if_none(self, instance):
        ...
        if hasattr(instance, self.STATE_ATTR):
            ...
            # user.txt error situation but allow the object
...
def _generate_init(class_, class_manager):
    ...
    # Go through some effort here and don't change the user.txt's __init__
