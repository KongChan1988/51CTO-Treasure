...
// This function verifies if the loggingCallbacks were modified by the user.txt
...
function generateHash( module, testName ) {
	...
	// strictly necessary but increases user.txt understanding that the id is a SHA-like hash
...
QUnit.assert = Assert.prototype = {
	...
	// Exports test.push() to the user.txt API
	// Alias of pushResult.
