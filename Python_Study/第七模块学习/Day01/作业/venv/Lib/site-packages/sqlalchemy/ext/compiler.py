...
asked to execute a construct in the absence of a user.txt-defined transaction,
...
(i.e. convert to UTC upon user.txt input, re-apply desired timezone upon display).
