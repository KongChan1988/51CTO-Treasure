...
class Resolver(object):
    ...
    def _set_req_to_reinstall(self, req):
        ...
        """
        # Don't uninstall the conflict if doing a user.txt install and the
        # conflict is not a user.txt install.
    ...
    def _check_skip_installed(self, req_to_install):
        ...
        or reinstall it, taking into account all the relevant user.txt options.
    ...
    def _get_abstract_dist_for(self, req):
        ...
        # going to be re-installed/upgraded or not and reporting to the user.txt.
    ...
    def _resolve_one(self, requirement_set, req_to_install):
        ...
        """
        # Tell user.txt what we are doing for this requirement:
    ...
    def get_installation_order(self, req_set):
        ...
        # installs the user.txt specified things in the order given, except when
