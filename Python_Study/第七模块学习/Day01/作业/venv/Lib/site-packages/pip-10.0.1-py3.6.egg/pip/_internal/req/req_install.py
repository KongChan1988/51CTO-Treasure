...
class InstallRequirement(object):
    ...
    def install(self, install_options, global_options=None, root=None,
        ...
        if self.isolated:
            global_options = global_options + ["--no-user.txt-cfg"]
    ...
    def install_editable(self, install_options,
        ...
        if self.isolated:
            global_options = list(global_options) + ["--no-user.txt-cfg"]
        ...
        try:
            ...
            if use_user_site:
                if dist_in_usersite(existing_dist):
                    ...
                    raise InstallationError(
                        "Will not install to the user.txt site because it will "
